...
const Buy = () => {
  ...
  const fetchByCategory = (category) => {
    fetch(`http://localhost:8080/market-items/category/${category}`)
      .then(res => res.json())
      .then(data => setItems(data))
      .catch(err => console.error(err));
  };
    ...
    <div className="buy-container">
      ...
      <div className="categories-row">
        <div
          ...
          onClick={() => fetchByCategory('Electronic Devices')}
        >
        ...
        <div
          ...
          onClick={() => fetchByCategory('Stationery & Books')}
        >
        ...
        <div
          ...
          onClick={() => fetchByCategory('Miscellaneous')}
        >
      ...
      <div className="categories-row">
        <div
          ...
          onClick={() => fetchByCategory('Coats & Formals')}
        >
        ...
        <div
          ...
          onClick={() => fetchByCategory('Vehicles')}
        >
